...
#[derive(Accounts)]
#[instruction(threshold: u8, credential_id: String, name: String)]
pub struct InitializeMultisig<'info> {
    #[account(
        ...
        space = 8 + 
               ...
               4 + name.len(), // name với 4 bytes cho độ dài
...
pub fn initialize_multisig(
    ...
    msg!("Đã khởi tạo ví MultiSign thành công với tên: {}", multisig.name);
